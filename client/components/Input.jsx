  ...
  return (
    <div className="text-sm" style={{ width: width || "97.5%" }}>
      ...
      <input
        ...
        className={cls(
          "border-gray-300 dark:bg-darkElevation-300 dark:placeholder:text-gray-500 dark:text-gray-200 dark:border-none dark:rounded-md text-gray-700 placeholder:text-gray-400 outline-none border-2 mt-1 px-2 py-[8px] rounded-sm w-full",
