...
const DashboardCount = ({count,title,text,icon}) => {
  return (
  <div className='bg-secondary text-white rounded-xl p-6 w-72 h-36 cursor-pointer flex items-center justify-between hover:bg-iconBg hover:text-white group transition'>
    <div>
      <div className='font-medium text-2xl'>{count}</div>
      <div className='text-gray-300 text-sm tracking-wide group-hover:text-white'>{title}</div>
